...
namespace Apps\Fintech\Packages\Etf\Amcs\Install;

use Apps\Fintech\Packages\Etf\Amcs\Install\Schema\EtfAmcs;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_etf_amcs'  => [
                    'schema'        => new EtfAmcs,
                    'model'         => new AppsFintechEtfAmcs,
                    'configParams'  =>
                        [
                            'min_index_chars' => 6
                        ]
